...
export const content = {
  en: {
    ...
    forum: {
      ...
      memory: {
          title: "Memory",
          text: "Explore our visual archive capturing moments from Forum sessions, workshops, and events. Each photo tells a story of dialogue, engagement, and collective commitment to democratic values."
      },
      archive: {
          title: "Archive",
          text: "Access articles, research papers, books, and reports that feature or discuss the Forum for National Dialogue and its contributions to Syrian civil society."
      },
      management: {
  ...
  ar: {
    ...
    about: {
      ...
      ourStory: {
          title: "قصتنا",
          text: "ولدت المؤسسة في أعقاب التحول السياسي في سوريا كمبادرة لضمان أن تكون العدالة والمساواة والشمول في قلب مستقبل البلاد. من خلال ربط نضالات ا��اضي بالاحتياجات الحالية، نخلق مسارات للمساءلة والحوار والتمكين."
      },
      vision: {
          title: "رؤيتنا",
      ...
      approach: {
          ...
          pillars: [
              ...
              { title: "مسارات العدالة والمساءلة", desc: "دعم الناجين من خال المساعدة القانونية والتوثيق؛ بناء الأسس لآليات المساءلة المستقبلية." },
    ...
    center: {
      ...
      intro: {
          ...
          text: "مركز حقوق الإنسان هو مركز بناء القدرات في المؤسسة. نستثمر في المحامين والمدافعين الشباب للانخراط في العدالة الانتقالي��. من خلال التدريب والتوجيه والتشبيك، نعد جيلاً جديداً من القادة."
      },
      curriculum: {
    ...
    forum: {
      ...
      memory: {
          title: "الذاكرة",
          text: "استكشف أرشيفنا البصري الذي يلتقط اللحظات من جلسات منتدى الحوار، وورش العمل، وفعاليات. كل صورة تروي قصة عن الحوار والمشاركة والالتزام الجماعي بالقيم الديمقراطية."
      },
      archive: {
          title: "الأرشيف",
          text: "وصول إلى المقالات والبحوث والكتب والتقارير التي تذكر أو تناقش منتدى الحوار الوطني ومساهماته في المجتمع المدني السوري."
      },
      management: {
          title: "فريق الإدارة",
    ...
    publications: {
      ...
      approach: {
          ...
          text: "إنتاج معرفة عملية وسهلة الوصول متجذرة في الواقع السوري. تهدف مواردنا باللغة العربية إلى جعل مفاهيم العدالة الانتقالية مفهومة للمجتمع المدني، مع تسليط ال��وء على وجهات نظر النساء والتجارب الإقليمية."
      },
      access: {
          title: "تصفح أعمالنا",
