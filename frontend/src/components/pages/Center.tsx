import { CheckCircle, BookOpen, Users, Award, Target, TrendingUp } from 'lucide-react';
              ...
              >
                  ...
                  <ul className="space-y-3">
                      {['Human Rights Law', 'Transitional Justice', 'Women\'s Rights', 'Advocacy'].map((item, i) => (
                          <motion.li
                            key={i}
                            className="flex items-center gap-3 text-slate-700 p-3 rounded-lg hover:bg-slate-50 transition-colors"
